...
export const SetHighlightSchema = z
  .object({
    leftThumbwheelHighlighted: z.boolean().nullable().optional(),
    leftLeverHighlighted: z.boolean().nullable().optional(),
    leftCollectiveHighlighted: z.boolean().nullable().optional(),
    leftStickHighlighted: z.boolean().nullable().optional(),
    highlightDurationSeconds: z.number().min(0).max(60).nullable().optional(),
    flashPeriodSeconds: z.number().min(0).max(10).nullable().optional(),
  })
  .strict();
export type SetHighlight = z.infer<typeof SetHighlightSchema>;
...
export const SetSimDataSchema = z
  .object({
    ...
    highlight: SetHighlightSchema.optional(),
  })
  .strict();
